...
export default function CVTemplateModern({ data }: { data: CVData }) {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-2xl font-bold tracking-tight" style={{ margin: 0 }}>
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-0 mt-3 text-sm text-blue-100">
        ...
        {data.summary && (
          <section className="mb-5">
            <h2
              ...
              style={{ color: '#1e40af', borderBottom: '2px solid #1e40af', paddingBottom: 4, display: 'inline-block' }}
            >
              Summary
            </h2>
