...
const Map<String, String> _en = {
  ...
  'profile_about_body':
      'Proviser is the U Smart field operations app for quality control, maintenance, and workspace management. It supports company, individual, and private workspace teams with ticketing, scheduling, expense tracking, QField map integration, and live coordination.',
...
const Map<String, String> _ar = {
  ...
  'profile_about_body':
      'Proviser هو تطبيق U Smart للعمليات الميدانية: ضبط الجودة، الصيانة، إدارة مساحات العمل، إصدار التذاكر، الجدولة، تتبع المصاريف، تكامل خرائط QField، وتنسيق مباشر بين الفرق.',
...
const Map<String, String> _ku = {
  ...
  'profile_about_body':
      'Proviser ئەپڵیکەیشنی U Smart بۆ کارەکانی مەیدانی: کۆنترۆڵی کوالیتی، چاککردنەوە، بەڕێوەبردنی workspace، تیکێت، خشتە، چاودێری مەسروفات، QField و ڕاستەوخۆیی نێوان تیمەکان.',
...
const Map<String, String> _tr = {
  ...
  'profile_about_body':
      'Proviser, U Smart’ın saha operasyonları uygulamasıdır: kalite kontrol, bakım, çalışma alanı yönetimi, talep takibi, planlama, masraf izleme, QField entegrasyonu ve canlı koordinasyon.',
