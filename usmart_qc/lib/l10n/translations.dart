...
const Map<String, String> _en = {
  ...
  'nav_profile': 'Profile',
  'nav_u_agent': 'U Agent',
  'u_agent_hint': 'Ask U Agent…',
  'u_agent_approve': 'Approve',
  'u_agent_reject': 'Reject',
  'u_agent_waiting_approval': 'Waiting for approval',
  'u_agent_listening': 'Listening…',
  'u_agent_speaking': 'Speaking…',
  'u_agent_thinking': 'Thinking…',
  'u_agent_auto_speak': 'Auto speak replies',
  'u_agent_voice_unavailable': 'Voice is unavailable on this device',
  'u_agent_overlay_hint': 'Talk, type, or attach files — like WhatsApp AI. Ask for reports and professional documents anytime.',
  'u_agent_attach_photo': 'Photo from gallery',
  'u_agent_attach_camera': 'Take photo',
  'u_agent_attach_file': 'Attach file',
  'u_agent_new_chat': 'New chat',
  'u_agent_history': 'Chat history',
  'u_agent_no_history': 'No saved chats yet',
  'u_agent_voice_ready': 'Talk to U Agent',
  'u_agent_voice_tap_interrupt': 'Tap the orb to interrupt',
  ...
  'u_agent_whatsapp_calls': 'Start / open calls',
  ...
  'u_agent_add_wa_contact': 'Add WhatsApp contact',
  'u_agent_add_wa_contact_hint': 'Save a name + phone for U Agent to message',
  'u_agent_contact_name': 'Name',
  'u_agent_contact_phone': 'Phone',
  'u_agent_save_contact': 'Save',
  'nav_inbox': 'Inbox',
  ...
  'pc_plans_title': 'Ticket Plans',
  'pc_plans_remaining': 'Tickets remaining',
  'pc_plans_tickets_short': 'left',
  'pc_plans_used': 'Used',
  'pc_plans_allowance': 'Total allowance',
  'pc_plans_unlimited': 'Unlimited',
  'pc_plans_unlimited_until': 'Unlimited until {{date}}',
  'pc_plans_free_note': 'Your first 30 tickets are free.',
  'pc_plans_quota_reached':
      'You have used all your tickets. Choose a plan to keep creating tickets.',
  'pc_plans_choose': 'Choose a plan',
  'pc_plans_manage_only':
      'Only the workspace owner or a manager can manage ticket plans.',
  'pc_plans_request_dialog_title': 'Request {{plan}}',
  'pc_plans_send': 'Send request',
  'pc_plan_pack100_name': '100 Tickets',
  'pc_plan_pack100_desc': '1,000 IQD per ticket',
  'pc_plan_pack100_total': 'Total: 100,000 IQD',
  'pc_plan_pack1000_name': '1000 Tickets',
  'pc_plan_pack1000_desc': '750 IQD per ticket',
  'pc_plan_pack1000_total': 'Total: 750,000 IQD',
  'pc_plan_yearly_name': 'Yearly Unlimited',
  'pc_plan_yearly_desc': 'Unlimited tickets — price negotiated',
  'pc_plan_request': 'Request',
  'pc_plan_request_pending': 'Plan request pending admin review',
  'pc_plan_phone_label': 'Contact phone',
  'pc_plan_phone_hint': 'A phone number the admin can reach you on.',
  'pc_plan_requested':
      'Plan request sent. The admin will send you an activation code.',
  'pc_activation_title': 'Have an activation code?',
  'pc_activation_hint': 'Enter the code the admin sent you to unlock your tickets.',
  'pc_activation_label': 'Activation code',
  'pc_activation_redeem': 'Activate',
  'pc_activation_success': 'Activated! You can create tickets again.',
  ...
  'st_all': 'All',
  'st_search_hint': 'Search tickets…',
  'st_no_tickets': 'No tickets for this site yet.',
  'st_no_match': 'No tickets match your filters.',
  'st_count': '{{shown}} of {{total}} tickets',
  'st_date_range': 'Date range',
  'st_export_excel': 'Export to Excel',
  'st_export_failed': 'Export failed. Please try again.',
  ...
  'pc_checklist_pdf_item': 'Item',
  'pc_checklist_pdf_severity': 'Severity',
  'pc_checklist_pdf_page': 'Page {{current}} / {{total}}',
  ...
  'pc_ws_techniques_category_supervision': 'Supervision',
  ...
  // ── v1.0.4 profile screen additions ──
  'profile_section_more': 'More',
  'profile_change_photo': 'Change profile photo',
  'profile_remove_photo': 'Remove photo',
  'profile_update_photo_failed': 'Could not update photo. Please try again.',
  'profile_contact_email_title': 'Contact email',
  'profile_contact_email_hint':
      'Optional public email for our team and ticket updates. Saved to your profile only.',
  'profile_contact_email_empty': 'Not set — tap to add an email',
  'profile_contact_email_invalid': 'Enter a valid email address',
  'profile_contact_email_save': 'Save',
  'profile_contact_email_remove': 'Remove',
  ...
  'profile_contact_whatsapp_hint': 'Open a conversation with the Provisor support team.',
  'profile_about': 'About Provisor',
  'profile_about_body':
      'Provisor is the U Smart field operations app for quality control, maintenance, and workspace management. It supports company, individual, and private workspace teams with ticketing, scheduling, expense tracking, QField map integration, and live coordination.',
  'profile_about_contact': 'Support contact',
  'profile_about_company': 'U Smart Technologies',
  'profile_report_issue': 'Report a problem',
  'profile_report_issue_hint': 'Send the admin team a bug, feature idea, or complaint.',
  'issue_reports_title': 'My reports',
  'issue_reports_empty': 'You have not submitted any reports yet.',
  'issue_reports_new': 'New report',
  'issue_reports_type': 'Type',
  'issue_reports_type_pick': 'Pick a type',
  'issue_reports_subject': 'Subject',
  'issue_reports_description': 'Describe the problem in detail',
  'issue_reports_submit': 'Submit report',
  'issue_reports_submitted': 'Report submitted. We will reply soon.',
  'issue_reports_submit_failed': 'Could not submit the report.',
  'issue_reports_status_pending': 'Pending',
  'issue_reports_status_in_progress': 'In progress',
  'issue_reports_status_completed': 'Completed',
  'issue_reports_status_rejected': 'Closed',
  'issue_reports_admin_note': 'Admin response',
  'whatsapp_unavailable': 'WhatsApp is not available on this device.',
  'department_settings_crew_section': 'Crew permissions',
  'department_settings_crew_expenses': 'Crew can log expenses',
  'department_settings_crew_expenses_hint':
      'When off, only the assigned lead on the main ticket can record expenses; crew members must ask the lead.',
  'department_settings_crew_close': 'Crew can close tickets',
  'department_settings_crew_close_hint':
      'When off, only the assigned lead on the main ticket can submit the completion report.',
  'live_staff_section': 'Field staff live',
  'live_staff_none': 'No live updates from the team yet.',
};
...
const Map<String, String> _ar = {
  ...
  'nav_u_agent': 'U Agent',
  'u_agent_hint': 'اسأل U Agent…',
  'u_agent_approve': 'موافقة',
  'u_agent_reject': 'رفض',
  'u_agent_waiting_approval': 'بانتظار الموافقة',
  'u_agent_listening': 'جاري الاستماع…',
  'u_agent_speaking': 'يتكلم…',
  'u_agent_thinking': 'يفكر…',
  'u_agent_auto_speak': 'قراءة الردود صوتياً',
  'u_agent_voice_unavailable': 'الصوت غير متاح على هذا الجهاز',
  'u_agent_overlay_hint': 'تكلم أو اكتب أو أرفق ملفات — مثل واتساب AI. اطلب تقارير وملفات احترافية بأي وقت.',
  'u_agent_attach_photo': 'صورة من المعرض',
  'u_agent_attach_camera': 'التقاط صورة',
  'u_agent_attach_file': 'إرفاق ملف',
  'u_agent_new_chat': 'محادثة جديدة',
  'u_agent_history': 'سجل المحادثات',
  'u_agent_no_history': 'لا توجد محادثات محفوظة بعد',
  'u_agent_voice_ready': 'تكلم مع U Agent',
  'u_agent_voice_tap_interrupt': 'اضغط على الكرة للمقاطعة',
  ...
  'u_agent_whatsapp_calls': 'بدء / فتح المكالمات',
  ...
  'u_agent_add_wa_contact': 'إضافة جهة واتساب',
  'u_agent_add_wa_contact_hint': 'احفظ اسماً ورقماً ليرسل U Agent عبر واتساب',
  'u_agent_contact_name': 'الاسم',
  'u_agent_contact_phone': 'الهاتف',
  'u_agent_save_contact': 'حفظ',
  ...
  'cancel': 'إلغاء',
  // ── باقات التذاكر / رموز التفعيل ──
  'pc_plans_title': 'باقات التذاكر',
  'pc_plans_remaining': 'التذاكر المتبقية',
  'pc_plans_tickets_short': 'متبقية',
  'pc_plans_used': 'المستخدمة',
  'pc_plans_allowance': 'الإجمالي المتاح',
  'pc_plans_unlimited': 'غير محدود',
  'pc_plans_unlimited_until': 'غير محدود حتى {{date}}',
  'pc_plans_free_note': 'أول ٣٠ تذكرة مجانية.',
  'pc_plans_quota_reached':
      'لقد استهلكت جميع تذاكرك. اختر باقة لمواصلة إنشاء التذاكر.',
  'pc_plans_choose': 'اختر باقة',
  'pc_plans_manage_only':
      'يمكن لمالك مساحة العمل أو المدير فقط إدارة باقات التذاكر.',
  'pc_plans_request_dialog_title': 'طلب {{plan}}',
  'pc_plans_send': 'إرسال الطلب',
  'pc_plan_pack100_name': '١٠٠ تذكرة',
  'pc_plan_pack100_desc': '١٠٠٠ دينار لكل تذكرة',
  'pc_plan_pack100_total': 'الإجمالي: ١٠٠٬٠٠٠ دينار',
  'pc_plan_pack1000_name': '١٠٠٠ تذكرة',
  'pc_plan_pack1000_desc': '٧٥٠ دينار لكل تذكرة',
  'pc_plan_pack1000_total': 'الإجمالي: ٧٥٠٬٠٠٠ دينار',
  'pc_plan_yearly_name': 'سنوي غير محدود',
  'pc_plan_yearly_desc': 'تذاكر غير محدودة — السعر بالتفاوض',
  'pc_plan_request': 'طلب',
  'pc_plan_request_pending': 'طلب الباقة قيد مراجعة المشرف',
  'pc_plan_phone_label': 'رقم التواصل',
  'pc_plan_phone_hint': 'رقم هاتف يمكن للمشرف التواصل معك عليه.',
  'pc_plan_requested': 'تم إرسال طلب الباقة. سيرسل لك المشرف رمز التفعيل.',
  'pc_activation_title': 'لديك رمز تفعيل؟',
  'pc_activation_hint': 'أدخل الرمز الذي أرسله المشرف لفتح تذاكرك.',
  'pc_activation_label': 'رمز التفعيل',
  'pc_activation_redeem': 'تفعيل',
  'pc_activation_success': 'تم التفعيل! يمكنك إنشاء التذاكر مجددًا.',
  ...
  'app_version': 'Provisor الإصدار 1.0.5',
  ...
  'st_all': 'الكل',
  'st_search_hint': 'ابحث في التذاكر…',
  'st_no_tickets': 'لا توجد تذاكر لهذا الموقع بعد.',
  'st_no_match': 'لا توجد تذاكر مطابقة للمرشحات.',
  'st_count': '{{shown}} من {{total}} تذكرة',
  'st_date_range': 'نطاق التاريخ',
  'st_export_excel': 'تصدير إلى Excel',
  'st_export_failed': 'فشل التصدير. حاول مرة أخرى.',
  'assigned_staff': 'الموظفون المعينون',
  'assigned_lead': 'المسؤول المعين',
  'crew_member': 'عضو الفريق',
  ...
  'pc_checklist_pdf_item': 'البند',
  'pc_checklist_pdf_severity': 'الأهمية',
  'pc_checklist_pdf_page': 'صفحة {{current}} / {{total}}',
  ...
  'pc_ws_techniques_category_supervision': 'الإشراف',
  ...
  // ── v1.0.4 ──
  'profile_section_more': 'المزيد',
  'profile_change_photo': 'تغيير صورة الملف الشخصي',
  'profile_remove_photo': 'حذف الصورة',
  'profile_update_photo_failed': 'تعذّر تحديث الصورة. حاول مجددًا.',
  'profile_contact_email_title': 'البريد الإلكتروني للتواصل',
  'profile_contact_email_hint':
      'بريد إلكتروني عام اختياري لفريقنا وتحديثات التذاكر. يُحفظ في ملفك الشخصي فقط.',
  'profile_contact_email_empty': 'لم يُحدّد — اضغط لإضافة بريد إلكتروني',
  'profile_contact_email_invalid': 'أدخل عنوان بريد إلكتروني صالحًا',
  'profile_contact_email_save': 'حفظ',
  'profile_contact_email_remove': 'إزالة',
  'profile_contact_email_saved': 'تم تحديث البريد الإلكتروني للتواصل.',
  ...
  'profile_contact_whatsapp_hint': 'ابدأ محادثة مع فريق دعم Provisor.',
  'profile_about': 'حول Provisor',
  'profile_about_body':
      'Provisor هو تطبيق U Smart للعمليات الميدانية: ضبط الجودة، الصيانة، إدارة مساحات العمل، إصدار التذاكر، الجدولة، تتبع المصاريف، تكامل خرائط QField، وتنسيق مباشر بين الفرق.',
  'profile_about_contact': 'جهة الدعم',
  'profile_about_company': 'U Smart Technologies',
  'profile_report_issue': 'الإبلاغ عن مشكلة',
  'profile_report_issue_hint': 'أرسل لفريق الإدارة بلاغ خطأ، اقتراحًا، أو شكوى.',
  'issue_reports_title': 'بلاغاتي',
  'issue_reports_empty': 'لم تُرسل أي بلاغ بعد.',
  'issue_reports_new': 'بلاغ جديد',
  'issue_reports_type': 'النوع',
  'issue_reports_type_pick': 'اختر النوع',
  'issue_reports_subject': 'العنوان',
  'issue_reports_description': 'صف المشكلة بالتفصيل',
  'issue_reports_submit': 'إرسال البلاغ',
  'issue_reports_submitted': 'تم إرسال البلاغ. سنرد عليك قريبًا.',
  'issue_reports_submit_failed': 'تعذّر إرسال البلاغ.',
  'issue_reports_status_pending': 'قيد الانتظار',
  'issue_reports_status_in_progress': 'قيد المعالجة',
  'issue_reports_status_completed': 'مكتمل',
  'issue_reports_status_rejected': 'مغلق',
  'issue_reports_admin_note': 'رد الإدارة',
  'whatsapp_unavailable': 'واتساب غير متاح على هذا الجهاز.',
  'department_settings_crew_section': 'صلاحيات الفريق',
  'department_settings_crew_expenses': 'الفريق يمكنه إضافة المصاريف',
  'department_settings_crew_expenses_hint':
      'عند الإيقاف، يقتصر تسجيل المصاريف على المسؤول الرئيسي عن التذكرة فقط.',
  'department_settings_crew_close': 'الفريق يمكنه إغلاق التذاكر',
  'department_settings_crew_close_hint':
      'عند الإيقاف، يقتصر إغلاق التذاكر على المسؤول الرئيسي عن التذكرة فقط.',
  'live_staff_section': 'الفريق الميداني مباشرة',
  'live_staff_none': 'لا توجد تحديثات مباشرة من الفريق بعد.',
};
...
const Map<String, String> _ku = {
  ...
  // ── پاکێجەکانی بلیت / کۆدی چالاککردن ──
  'pc_plans_title': 'پاکێجەکانی بلیت',
  'pc_plans_remaining': 'بلیتی ماوە',
  'pc_plans_tickets_short': 'ماوە',
  'pc_plans_used': 'بەکارهاتوو',
  'pc_plans_allowance': 'کۆی بەردەست',
  'pc_plans_unlimited': 'بێ سنوور',
  'pc_plans_unlimited_until': 'بێ سنوور تا {{date}}',
  'pc_plans_free_note': 'یەکەم ٣٠ بلیت بەخۆڕاییە.',
  'pc_plans_quota_reached':
      'هەموو بلیتەکانت بەکارهێنا. پاکێجێک هەڵبژێرە بۆ بەردەوامبوون.',
  'pc_plans_choose': 'پاکێجێک هەڵبژێرە',
  'pc_plans_manage_only':
      'تەنها خاوەن یان بەڕێوەبەری شوێنی کار دەتوانێت پاکێجەکان بەڕێوە ببات.',
  'pc_plans_request_dialog_title': 'داواکردنی {{plan}}',
  'pc_plans_send': 'ناردنی داواکاری',
  'pc_plan_pack100_name': '١٠٠ بلیت',
  'pc_plan_pack100_desc': '١٠٠٠ دینار بۆ هەر بلیتێک',
  'pc_plan_pack100_total': 'کۆ: ١٠٠٬٠٠٠ دینار',
  'pc_plan_pack1000_name': '١٠٠٠ بلیت',
  'pc_plan_pack1000_desc': '٧٥٠ دینار بۆ هەر بلیتێک',
  'pc_plan_pack1000_total': 'کۆ: ٧٥٠٬٠٠٠ دینار',
  'pc_plan_yearly_name': 'ساڵانە بێ سنوور',
  'pc_plan_yearly_desc': 'بلیتی بێ سنوور — نرخ بە گفتوگۆ',
  'pc_plan_request': 'داواکردن',
  'pc_plan_request_pending': 'داواکاری پاکێج لە چاوەڕوانی پەسەندکردنی بەڕێوەبەرە',
  'pc_plan_phone_label': 'ژمارەی پەیوەندی',
  'pc_plan_phone_hint': 'ژمارەیەک کە بەڕێوەبەر بتوانێت پەیوەندیت پێوە بکات.',
  'pc_plan_requested': 'داواکاری پاکێج نێردرا. بەڕێوەبەر کۆدی چالاککردنت بۆ دەنێرێت.',
  'pc_activation_title': 'کۆدی چالاککردنت هەیە؟',
  'pc_activation_hint': 'ئەو کۆدە بنووسە کە بەڕێوەبەر ناردوویەتی بۆ کردنەوەی بلیتەکانت.',
  'pc_activation_label': 'کۆدی چالاککردن',
  'pc_activation_redeem': 'چالاککردن',
  'pc_activation_success': 'چالاککرا! دەتوانیت دووبارە بلیت دروست بکەیت.',
  ...
  'app_version': 'Provisor وەشانی 1.0.5',
  ...
  'st_all': 'هەموو',
  'st_search_hint': 'گەڕان لە بلیتەکان…',
  'st_no_tickets': 'هێشتا هیچ بلیتێک بۆ ئەم شوێنە نییە.',
  'st_no_match': 'هیچ بلیتێک لەگەڵ فلتەرەکان ناگونجێت.',
  'st_count': '{{shown}} لە {{total}} بلیت',
  'st_date_range': 'ماوەی بەروار',
  'st_export_excel': 'هەناردن بۆ Excel',
  'st_export_failed': 'هەناردن سەرکەوتوو نەبوو. دووبارە هەوڵ بدە.',
  'assigned_staff': 'ستافی دیاریکراو',
  'crew_member': 'ئەندامی تیم',
  'assigned_lead': 'بەرپرسی دیاریکراو',
  ...
  'pc_checklist_pdf_item': 'بڕگە',
  'pc_checklist_pdf_severity': 'گرنگی',
  'pc_checklist_pdf_page': 'لاپەڕە {{current}} / {{total}}',
  ...
  'pc_ws_techniques_category_supervision': 'سەرپەرشتی',
  ...
  // ── v1.0.4 ──
  'profile_section_more': 'زیاتر',
  'profile_change_photo': 'گۆڕینی وێنەی پرۆفایل',
  'profile_remove_photo': 'سڕینەوەی وێنە',
  'profile_update_photo_failed': 'نوێکردنەوەی وێنە سەرنەکەوت. دیسان هەوڵ بدە.',
  'profile_contact_email_title': 'ئیمەیڵی پەیوەندی',
  'profile_contact_email_hint':
      'ئیمەیڵێکی گشتیی ئارەزوومەندانە بۆ تیمەکەمان و نوێکردنەوەی بلیتەکان. تەنها لە پرۆفایلت پاشەکەوت دەکرێت.',
  'profile_contact_email_empty':
      'دانراو نییە — کلیک بکە بۆ زیادکردنی ئیمەیڵ',
  'profile_contact_email_invalid': 'ناونیشانێکی ئیمەیڵی دروست بنووسە',
  'profile_contact_email_save': 'پاشەکەوتکردن',
  'profile_contact_email_remove': 'سڕینەوە',
  'profile_contact_email_saved': 'ئیمەیڵی پەیوەندی نوێکرایەوە.',
  ...
  'profile_contact_whatsapp_hint': 'گفتوگۆ لەگەڵ تیمی پشتیوانی Provisor دەستپێبکە.',
  'profile_about': 'دەربارەی Provisor',
  'profile_about_body':
      'Provisor ئەپڵیکەیشنی U Smart بۆ کارەکانی مەیدانی: کۆنترۆڵی کوالیتی، چاککردنەوە، بەڕێوەبردنی workspace، تیکێت، خشتە، چاودێری مەسروفات، QField و ڕاستەوخۆیی نێوان تیمەکان.',
  'profile_about_contact': 'پشتیوانی',
  'profile_about_company': 'U Smart Technologies',
  'profile_report_issue': 'ڕاپۆرتکردنی کێشە',
  'profile_report_issue_hint': 'بۆ ئەدمین ڕاپۆرت بنێرە دەربارەی کێشە، پێشنیار یان گلەیی.',
  'issue_reports_title': 'ڕاپۆرتەکانم',
  'issue_reports_empty': 'هیچ ڕاپۆرتێک نەنێردراوە.',
  'issue_reports_new': 'ڕاپۆرتی نوێ',
  'issue_reports_type': 'جۆر',
  'issue_reports_type_pick': 'جۆر هەڵبژێرە',
  'issue_reports_subject': 'سەردێڕ',
  'issue_reports_description': 'کێشەکە بە وردی شرۆڤە بکە',
  'issue_reports_submit': 'ناردنی ڕاپۆرت',
  'issue_reports_submitted': 'ڕاپۆرت نێردرا. زوو وەڵامت دەدەینەوە.',
  'issue_reports_submit_failed': 'ناردنی ڕاپۆرت سەرنەکەوت.',
  'issue_reports_status_pending': 'لە چاوەڕوانیدا',
  'issue_reports_status_in_progress': 'لە جێبەجێکردندا',
  'issue_reports_status_completed': 'تەواوبووە',
  'issue_reports_status_rejected': 'داخراوە',
  'issue_reports_admin_note': 'وەڵامی ئەدمین',
  'whatsapp_unavailable': 'واتساپ لەسەر ئەم ئامێرە بەردەست نیە.',
  'department_settings_crew_section': 'دەسەڵاتی ستاف',
  'department_settings_crew_expenses': 'ستاف دەتوانێت مەسروف زیاد بکات',
  'department_settings_crew_expenses_hint':
      'کاتێک کوژاندراوەتەوە، تەنها سەرپەرشتیاری سەرەکی دەتوانێت مەسروف تۆمار بکات.',
  'department_settings_crew_close': 'ستاف دەتوانێت تیکێت دابخات',
  'department_settings_crew_close_hint':
      'کاتێک کوژاندراوەتەوە، تەنها سەرپەرشتیاری سەرەکی دەتوانێت تیکێت دابخات.',
  'live_staff_section': 'ستافی مەیدانی ڕاستەوخۆ',
  'live_staff_none': 'هێشتا هیچ نوێکردنەوەیەکی ڕاستەوخۆ لە تیم نیە.',
};
...
const Map<String, String> _tr = {
  ...
  'cancel': 'İptal',
  // ── Bilet paketleri / etkinleştirme kodları ──
  'pc_plans_title': 'Bilet Paketleri',
  'pc_plans_remaining': 'Kalan bilet',
  'pc_plans_tickets_short': 'kaldı',
  'pc_plans_used': 'Kullanılan',
  'pc_plans_allowance': 'Toplam hak',
  'pc_plans_unlimited': 'Sınırsız',
  'pc_plans_unlimited_until': '{{date}} tarihine kadar sınırsız',
  'pc_plans_free_note': 'İlk 30 bilet ücretsizdir.',
  'pc_plans_quota_reached':
      'Tüm biletlerinizi kullandınız. Devam etmek için bir paket seçin.',
  'pc_plans_choose': 'Bir paket seçin',
  'pc_plans_manage_only':
      'Yalnızca çalışma alanı sahibi veya yönetici bilet paketlerini yönetebilir.',
  'pc_plans_request_dialog_title': '{{plan}} iste',
  'pc_plans_send': 'İstek gönder',
  'pc_plan_pack100_name': '100 Bilet',
  'pc_plan_pack100_desc': 'Bilet başına 1.000 IQD',
  'pc_plan_pack100_total': 'Toplam: 100.000 IQD',
  'pc_plan_pack1000_name': '1000 Bilet',
  'pc_plan_pack1000_desc': 'Bilet başına 750 IQD',
  'pc_plan_pack1000_total': 'Toplam: 750.000 IQD',
  'pc_plan_yearly_name': 'Yıllık Sınırsız',
  'pc_plan_yearly_desc': 'Sınırsız bilet — fiyat görüşülür',
  'pc_plan_request': 'İste',
  'pc_plan_request_pending': 'Paket isteği yönetici onayı bekliyor',
  'pc_plan_phone_label': 'İletişim telefonu',
  'pc_plan_phone_hint': 'Yöneticinin size ulaşabileceği bir telefon numarası.',
  'pc_plan_requested':
      'Paket isteği gönderildi. Yönetici size bir etkinleştirme kodu gönderecek.',
  'pc_activation_title': 'Etkinleştirme kodunuz mu var?',
  'pc_activation_hint': 'Biletlerinizi açmak için yöneticinin gönderdiği kodu girin.',
  'pc_activation_label': 'Etkinleştirme kodu',
  'pc_activation_redeem': 'Etkinleştir',
  'pc_activation_success': 'Etkinleştirildi! Yeniden bilet oluşturabilirsiniz.',
  ...
  'st_all': 'Tümü',
  'st_search_hint': 'Biletlerde ara…',
  'st_no_tickets': 'Bu saha için henüz bilet yok.',
  'st_no_match': 'Filtrelerinize uyan bilet yok.',
  'st_count': '{{shown}} / {{total}} bilet',
  'st_date_range': 'Tarih aralığı',
  'st_export_excel': 'Excel\'e aktar',
  'st_export_failed': 'Dışa aktarma başarısız. Tekrar deneyin.',
  'assigned_staff': 'Atanan Personel',
  'assigned_lead': 'Atanan Sorumlu',
  ...
  'pc_checklist_pdf_item': 'Madde',
  'pc_checklist_pdf_severity': 'Önem',
  'pc_checklist_pdf_page': 'Sayfa {{current}} / {{total}}',
  ...
  'pc_ws_techniques_category_supervision': 'Denetim',
  ...
  // ── v1.0.4 ──
  'profile_section_more': 'Daha fazla',
  'profile_change_photo': 'Profil fotoğrafını değiştir',
  'profile_remove_photo': 'Fotoğrafı kaldır',
  'profile_update_photo_failed': 'Fotoğraf güncellenemedi. Tekrar deneyin.',
  'profile_contact_email_title': 'İletişim e-postası',
  'profile_contact_email_hint':
      'Ekibimiz ve talep güncellemeleri için isteğe bağlı bir e-posta. Yalnızca profilinizde saklanır.',
  'profile_contact_email_empty':
      'Ayarlanmadı — e-posta eklemek için dokunun',
  'profile_contact_email_invalid': 'Geçerli bir e-posta adresi girin',
  'profile_contact_email_save': 'Kaydet',
  'profile_contact_email_remove': 'Kaldır',
  'profile_contact_email_saved': 'İletişim e-postası güncellendi.',
  ...
  'profile_contact_whatsapp_hint': 'Provisor destek ekibi ile sohbet başlatın.',
  'profile_about': 'Provisor hakkında',
  'profile_about_body':
      'Provisor, U Smart’ın saha operasyonları uygulamasıdır: kalite kontrol, bakım, çalışma alanı yönetimi, talep takibi, planlama, masraf izleme, QField entegrasyonu ve canlı koordinasyon.',
  'profile_about_contact': 'Destek',
  'profile_about_company': 'U Smart Technologies',
  'profile_report_issue': 'Sorun bildir',
  'profile_report_issue_hint': 'Yönetici ekibe hata, öneri ya da şikayet gönderin.',
  'issue_reports_title': 'Raporlarım',
  'issue_reports_empty': 'Henüz rapor göndermediniz.',
  'issue_reports_new': 'Yeni rapor',
  'issue_reports_type': 'Tür',
  'issue_reports_type_pick': 'Tür seçin',
  'issue_reports_subject': 'Konu',
  'issue_reports_description': 'Sorunu ayrıntılı açıklayın',
  'issue_reports_submit': 'Raporu gönder',
  'issue_reports_submitted': 'Rapor gönderildi. Kısa süre içinde dönüş yapılacaktır.',
  'issue_reports_submit_failed': 'Rapor gönderilemedi.',
  'issue_reports_status_pending': 'Beklemede',
  'issue_reports_status_in_progress': 'İşlemde',
  'issue_reports_status_completed': 'Tamamlandı',
  'issue_reports_status_rejected': 'Kapandı',
  'issue_reports_admin_note': 'Yönetici yanıtı',
  'whatsapp_unavailable': 'Bu cihazda WhatsApp yok.',
  'department_settings_crew_section': 'Ekip izinleri',
  'department_settings_crew_expenses': 'Ekip masraf ekleyebilir',
  'department_settings_crew_expenses_hint':
      'Kapalıyken yalnızca atanmış lider masraf girebilir; ekip üyeleri liderden talep etmelidir.',
  'department_settings_crew_close': 'Ekip bilet kapatabilir',
  'department_settings_crew_close_hint':
      'Kapalıyken yalnızca atanmış lider bileti kapatabilir.',
  'live_staff_section': 'Saha ekibi canlı',
  'live_staff_none': 'Henüz ekipten canlı güncelleme yok.',
};
