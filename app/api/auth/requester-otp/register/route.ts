...
/**
 * Create an active Provisor (ticket_requester) account after email OTP — no admin approval.
 */
      ...
      return NextResponse.json(
        {
          success: false,
          message:
            'This email is registered on the coordinator platform. Open the sign-in screen and use email code — no separate sign-up.',
        },
        { status: 409 }
      );
    }
